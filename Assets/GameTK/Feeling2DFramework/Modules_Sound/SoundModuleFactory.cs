...
namespace NJM.Modules_Sound {
    ...
    public static class SoundModuleFactory {
        ...
        public static SoundModuleEntity Create(SoundModuleContext ctx, int typeGroup, int typeID, UniqueSignature belong, Vector2 happenPos) {
